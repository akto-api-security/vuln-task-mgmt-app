...
return [
    ...
    'schemas' => [
        'default' => [
            'query' => [
                // Task queries
                \App\GraphQL\Queries\Tasks\TasksQuery::class,
                \App\GraphQL\Queries\Tasks\TaskQuery::class,
            ],
            'mutation' => [
                // Task mutations
                \App\GraphQL\Mutations\Tasks\CreateTaskMutation::class,
                \App\GraphQL\Mutations\Tasks\UpdateTaskMutation::class,
                \App\GraphQL\Mutations\Tasks\DeleteTaskMutation::class,
            ],
